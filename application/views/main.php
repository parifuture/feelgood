<body class="preview" data-spy="scroll" data-target=".subnav" data-offset="50" cz-shortcut-listen="true">
  <div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container">
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </a>
        <a class="brand" href="../">Friend Competiable </a>
      </div>
    </div>
  </div>
  <div class="container">
    <header class="jumbotron subhead" id="overview">
      <h1>Most Compatible Friend</h1>
      <canvas id=c></canvas>
      <script>
      (function() {
  ...
  init = function(e) {
    ...
    changeWord('Most Compatible Friend');
  ...
  animate();
      ...
      <p class="lead">
        Login using facebook to find out.
      </p>
    </header>
    <div class="row">
        <?php if (@$friends):
        ...
        <div id="center-container">
          ...
          <a class="btn btn-primary btn-large" href="<?php echo $logout_url ?>">Logout of this thing</a>
        </div>
          <?php else: ?>
            <div class="span3">Please Click here to proceed ---></div>
            <div class="span3">
              <a class="btn btn-primary btn-large" href="<?php echo $login_url ?>">Login To See The Magic</a>
            </div>
            <div class="span3">Be patient, we will get data and process it to find the right match!</div>
          <?php endif; ?>
    </div>
  </div>
  <!-- /container -->
